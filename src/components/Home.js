    ...
    <div className="h-screen flex flex-col">
      ...
      <div className="h-full bg-white p-9">
        <div className="container h-full grid grid-cols-1 lg:grid-cols-12 mx-auto gap-3 md:gap-0">
          <div
            className="col-span-6 flex lg:items-start md:justify-start lg:justify-center flex-col lg:order-first order-last text-center"
            data-aos="fade-right"
          >
            <div className="text-4xl lg:text-7xl font-bold">
              Hi, I'm <span className="text-blue-900">Christine</span>
            </div>
            <div className="text-justify font-medium">
              A passionate Web Developer who likes to code from scratch and
              build innovative ideas in to the browser. Exposed on creating and
              designing web applications through different frameworks and
              libraries.
            </div>
          ...
          >
            <div className="relative">
              ...
              <img
                src={personalImgPng}
                alt=""
                className="absolute rounded-full lg:w-96 md:w-80 w-64 top-0"
              />
            </div>
          </div>
        </div>
